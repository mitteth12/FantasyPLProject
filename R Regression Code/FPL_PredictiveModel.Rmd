...
gw21_projectionsA <- rbind(gw21)
gw22_projectionsA <- rbind(gw21_projectionsA, gw22)
gw23_projectionsA <- rbind(gw22_projectionsA, gw23)
gw24_projectionsA <- rbind(gw23_projectionsA, gw24)
gw25_projectionsA <- rbind(gw24_projectionsA,gw25)
#gw26_projectionsA <- rbind(gw_25projectionsA,gw26)

#Last Week's Project Model
Y = gw24_projectionsA
#Current Week's Projection Model
YY = gw25_projectionsA
```
