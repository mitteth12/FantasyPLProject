...
gw23_projectionsA <- rbind(gw23)
gw24_projectionsA <- rbind(gw23_projectionsA, gw24)
gw25_projectionsA <- rbind(gw24_projectionsA,gw25)
gw26_projectionsA <- rbind(gw25_projectionsA,gw26)
gw27_projectionsA <- rbind(gw26_projectionsA,gw27)
#gw28_projectionsA <- rbind(gw27_projectionsA,gw28)

#Last Week's Project Model
Y = gw26_projectionsA
#Current Week's Projection Model
YY = gw27_projectionsA
```
