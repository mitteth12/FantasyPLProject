...
gw26_projectionsA <- rbind(gw26)
gw27_projectionsA <- rbind(gw26_projectionsA,gw27)
gw28_projectionsA <- rbind(gw27_projectionsA,gw28)
gw29_projectionsA <- rbind(gw28_projectionsA,gw29)
gw30_projectionsA <- rbind(gw29_projectionsA,gw30)
#gw31_projectionsA <- rbind(gw30_projectionsA,gw31)

#Last Week's Project Model
Y = gw29_projectionsA
#Current Week's Projection Model
YY = gw30_projectionsA
```
